...
""")
    ...
    def put(self, local: Path, remote: str):
        ...
        CHUNK_SIZE = 8192  # Small chunks for memory-constrained devices
...
class CalSciApp:
    ...
    def draw(self):
        ...
        # Subtitle
        subtitle = self.font.render("CalSci MicroPython Tool", True, Colors.TEXT_DIM)
    ...
    def handle_flash(self):
        ...
        try:
            ...
            if not ports:
                raise RuntimeError("No CalSci detected")
            
            port = ports[0]
            self.log(f"CalSci found: {port}", "success")
